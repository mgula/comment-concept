...
/*To do:
	- add vote column to database and keep track of votes
	- error and success classes for formDiv
	
  Bugs:
	- PHP_EOL prints as a space instead of newline
*/
...
$(document).on('submit','#ajax-contact',function(e) {
	...
	var submitFormData = $('#ajax-contact').serialize();

	$.ajax({
		type: 'POST',
		url: $('#ajax-contact').attr('action'),
		data: submitFormData //send like/dislike button status to submit.php here maybe?
